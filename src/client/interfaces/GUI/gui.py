...
if __name__ == "__main__":
    ...
    ui.apply_initial_configuration_before(
        config,
        helper.Vector2D(*screen.get_size())
    )
    # pages creation and initialization
    page_controller = ui.PageController(
        {
            "anteroom": ui.Page(
                pygame.Color(config.interface.pages\
                             .anteroom.style.background),
                {
                    "main": ui.Window(
                        ui.Vector2D(*screen.get_size()),
                        ui.Vector2D(0, 0), {
                        "button_play_online": ui.Button(
                            config.interface.pages.anteroom\
                                .elements.button_play_online.text,
                            events.button_play_online_on_click,
                            helper.to_dict(config\
                                .interface.pages.anteroom\
                                    .elements.button_play_online.style)
                        ),
                        "button_play_with_friend": ui.Button(
                            config.interface\
                                .pages.anteroom.elements\
                                    .button_play_with_friend.text,
                            events.button_play_with_friend_on_click,
                            helper.to_dict(config.interface\
                                .pages.anteroom.elements\
                                    .button_play_with_friend.style)
                        ),
                        "overlay": ui.Div(
                            {},
                            helper.to_dict(config.interface\
                                .pages.anteroom.elements.overlay.style)
                        ),
                        "form": ui.Div(
                            {
                                "input_field_0": ui.InputInteger(
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_0.value,
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_0.min_value,
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_0.max_value,
                                    helper.to_dict(config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_0.style)
                                ),
                                "input_field_1": ui.InputInteger(
                                    ...
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_1.min_value,
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_1.max_value,
                                    helper.to_dict(config.interface\
                                        .pages.anteroom.elements.form.elements
                                        .input_field_1.style)
                                ),
                                "input_field_2": ui.InputInteger(
                                    ...
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_2.min_value,
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_2.max_value,
                                    helper.to_dict(config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_2.style)
                                ),
                                "input_field_3": ui.InputInteger(
                                    ...
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_3.min_value,
                                    config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_3.max_value,
                                    helper.to_dict(config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .input_field_3.style)
                                ),
                                ...
                                "continue_button": ui.Button(
                                    ...
                                    helper.to_dict(config.interface.pages\
                                        .anteroom.elements.form.elements\
                                            .continue_button.style)
                                )
                            },
                            helper.to_dict(config.interface.pages\
                                .anteroom.elements.form.style)
                        )
                    }, 0)
                }
            ),
            "waiting_room": ui.Page(
                    ...
                    .waiting_room.style.background),
                {
                    "main": ui.Window(
                        ...
                        {
                            "image": ui.Image(
                                BASE_DIR / config.interface.pages\
                                    .waiting_room.elements.loader.path,
                                helper.to_dict(config.interface.pages\
                                    .waiting_room.elements.loader.style)
                            ),
                            "text": ui.Text(
                                config.interface.pages\
                                    .waiting_room.elements.text.text,
                                helper.to_dict(config.interface.pages\
                                    .waiting_room.elements.text.style)
                            ),
                            "leave": ui.Button(
                                config.interface.pages\
                                    .waiting_room.elements.leave.text,
                                events.button_leave_waiting_room,
                                helper.to_dict(config.interface.pages\
                                    .waiting_room.elements.leave.style)
                            )
                        },
                        0
                    )
                        ...
                        ui.Vector2D(),
                        {
                            "container": ui.Div(
                                    ...
                                    "grid-container": ui.Div(
                                        {
                                            "grid": ui.Grid(
                                                ...
                                                helper.to_dict(
                                                    config.interface.pages\
                                                    .battle.elements.container\
                                                    .elements.grid_container\
                                                    .elements.grid.style)
                                            )
                                        },
                                        helper.to_dict(
                                            config.interface.pages.battle\
                                    ...
                                    "panel-container": ui.Div(
                                        {
                                            ...
                                            "time": ui.Button(
                                                ...
                                                helper.to_dict(
                                                    ...
                                                    .container.elements\
                                                    .panel_container.elements\
                                                    .player_1.elements.time\
                                                    .style)
                                            ),
                                "name": ui.Text(
                                    config.interface.pages.battle.elements\
                                        .container.elements.panel_container\
                                            .elements.player_1.elements\
                                                .name.text,
                                    helper.to_dict(config.interface\
                                    ...
                                    helper.to_dict(config.interface\
                                        .pages.battle.elements.container\
                                        .elements.panel_container.elements\
                                        .player_1.style)
                                ),
                                        "player_2": ui.Div(
                                            {
                                ...
                                "name": ui.Text(
                                    ...
                                    .elements.player_2.elements\
                                    .name.text,
                                    helper.to_dict(config.interface\
                                    .pages.battle.elements.container\
                                    .elements.panel_container.elements\
                                    .player_2.elements.name.style)
                                )
                                            },
                                            helper.to_dict(config\
                                            .interface.pages.battle\
                                            .elements.container.elements\
                                            .panel_container.elements\
                                                .player_2.style)
                                        ),
                                    ...
                                    "text": ui.Text(
                                        config.interface.pages.battle\
                                        .elements.container.elements\
                                        .panel_container.elements.text.text,
                                        helper.to_dict(config.interface\
                                            .pages.battle.elements.container\
                                            .elements.panel_container\
                                            .elements.text.style)
                                        ...
                                        helper.to_dict(config.interface\
                                        .pages.battle.elements.container\
                                        .elements.panel_container.style)
                                    )
                                },
                                helper.to_dict(config.interface\
                                    .pages.battle.elements.container.style)
                            ),
                        },
                        0
                    )
